...
public class SongController {
  ...
  @Autowired private SongServiceImpl songService;
  ...
  public class MyPicConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
      registry
          .addResourceHandler("/img/songPic/**")
          .addResourceLocations(
              "file:E:\\Users\\Lenovo\\Desktop\\Music_recommend\\Music_recommend\\music-server\\img\\songPic\\");
      registry
          .addResourceHandler("/song/**")
          .addResourceLocations(
              "file:E:\\Users\\Lenovo\\Desktop\\Music_recommend\\Music_recommend\\music-server\\song\\");
    }
  }
  ...
  public Object addSong(HttpServletRequest req, @RequestParam("file") MultipartFile mpfile) {
    ...
    String filePath =
        System.getProperty("user.dir") + System.getProperty("file.separator") + "song";
  ...
  public Object updateSongPic(
      @RequestParam("file") MultipartFile urlFile, @RequestParam("id") int id) {
    JSONObject jsonObject = new JSONObject();
